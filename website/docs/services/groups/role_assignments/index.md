...
<tr><td><b>Id</b></td><td><CopyableCode code="openai_admin.groups.role_assignments" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-group_id"><code>group_id</code></a>, <a href="#parameter-role_id"><code>role_id</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
<tr id="parameter-group_id">
    ...
    <td><code>string</code></td>
    <td>The ID of the group to modify.</td>
</tr>
<tr id="parameter-role_id">
    <td><CopyableCode code="role_id" /></td>
    <td><code>string</code></td>
    <td>The ID of the organization role to remove from the group.</td>
</tr>
<tr id="parameter-after">
    <td><CopyableCode code="after" /></td>
    <td><code>string</code></td>
    <td>Cursor for pagination. Provide the value from the previous response's `next` field to continue listing organization roles.</td>
</tr>
<tr id="parameter-limit">
    <td><CopyableCode code="limit" /></td>
    <td><code>integer</code></td>
    <td>A limit on the number of organization role assignments to return.</td>
</tr>
<tr id="parameter-order">
    <td><CopyableCode code="order" /></td>
    <td><code>string</code></td>
    <td>Sort order for the returned organization roles.</td>
</tr>
</tbody>
</table>
...
resource_type,
updated_at
FROM openai_admin.groups.role_assignments
...
```sql
INSERT INTO openai_admin.groups.role_assignments (
role_id,
group_id
)
SELECT 
...
```sql
DELETE FROM openai_admin.groups.role_assignments
WHERE group_id = '{{ group_id }}' --required
