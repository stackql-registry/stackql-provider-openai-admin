...
<tr><td><b>Id</b></td><td><CopyableCode code="openai_admin.usage.completions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-end_time"><code>end_time</code></a>, <a href="#parameter-bucket_width"><code>bucket_width</code></a>, <a href="#parameter-project_ids"><code>project_ids</code></a>, <a href="#parameter-user_ids"><code>user_ids</code></a>, <a href="#parameter-api_key_ids"><code>api_key_ids</code></a>, <a href="#parameter-models"><code>models</code></a>, <a href="#parameter-batch"><code>batch</code></a>, <a href="#parameter-group_by"><code>group_by</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td></td>
</tr>
</tbody>
</table>
...
<tr id="parameter-batch">
    <td><CopyableCode code="batch" /></td>
    <td><code>boolean</code></td>
    <td>If `true`, return batch jobs only. If `false`, return non-batch jobs only. By default, return both. </td>
</tr>
...
<tr id="parameter-group_by">
    ...
    <td><code>array</code></td>
    <td>Group the usage data by the specified fields. Support fields include `project_id`, `user_id`, `api_key_id`, `model`, `batch`, `service_tier` or any combination of them.</td>
</tr>
