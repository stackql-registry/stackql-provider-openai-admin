...
<tr><td><b>Id</b></td><td><CopyableCode code="openai_admin.usage.images" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-end_time"><code>end_time</code></a>, <a href="#parameter-bucket_width"><code>bucket_width</code></a>, <a href="#parameter-sources"><code>sources</code></a>, <a href="#parameter-sizes"><code>sizes</code></a>, <a href="#parameter-project_ids"><code>project_ids</code></a>, <a href="#parameter-user_ids"><code>user_ids</code></a>, <a href="#parameter-api_key_ids"><code>api_key_ids</code></a>, <a href="#parameter-models"><code>models</code></a>, <a href="#parameter-group_by"><code>group_by</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a></td>
    <td></td>
</tr>
</tbody>
</table>
...
<tr id="parameter-api_key_ids">
    ...
    <td><code>array</code></td>
    <td>Return only usage for these API keys.</td>
</tr>
...
<tr id="parameter-group_by">
    ...
    <td><code>array</code></td>
    <td>Group the usage data by the specified fields. Support fields include `project_id`, `user_id`, `api_key_id`, `model`, `size`, `source` or any combination of them.</td>
</tr>
...
<tr id="parameter-models">
    ...
    <td><code>array</code></td>
    <td>Return only usage for these models.</td>
</tr>
...
<tr id="parameter-sizes">
    <td><CopyableCode code="sizes" /></td>
    <td><code>array</code></td>
    <td>Return only usages for these image sizes. Possible values are `256x256`, `512x512`, `1024x1024`, `1792x1792`, `1024x1792` or any combination of them.</td>
</tr>
<tr id="parameter-sources">
    <td><CopyableCode code="sources" /></td>
    <td><code>array</code></td>
    <td>Return only usages for these sources. Possible values are `image.generation`, `image.edit`, `image.variation` or any combination of them.</td>
</tr>
<tr id="parameter-user_ids">
    <td><CopyableCode code="user_ids" /></td>
    <td><code>array</code></td>
    <td>Return only usage for these users.</td>
</tr>
</tbody>
</table>
